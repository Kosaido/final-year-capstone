...
class Metaclass_BatteryStatus(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            ...
            'WARNING_UNHEALTHY': cls.__constants['WARNING_UNHEALTHY'],
            'WARNING_CHARGING': cls.__constants['WARNING_CHARGING'],
    ...
    @property
    def WARNING_UNHEALTHY(self):
        """Message constant 'WARNING_UNHEALTHY'."""
        return Metaclass_BatteryStatus.__constants['WARNING_UNHEALTHY']

    @property
    def WARNING_CHARGING(self):
        """Message constant 'WARNING_CHARGING'."""
        return Metaclass_BatteryStatus.__constants['WARNING_CHARGING']
