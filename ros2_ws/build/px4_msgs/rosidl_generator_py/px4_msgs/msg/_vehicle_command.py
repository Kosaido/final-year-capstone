...
class Metaclass_VehicleCommand(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            ...
            'VEHICLE_CMD_DO_SET_MISSION_CURRENT': cls.__constants['VEHICLE_CMD_DO_SET_MISSION_CURRENT'],
            ...
            'VEHICLE_CMD_DO_SET_GLOBAL_ORIGIN': cls.__constants['VEHICLE_CMD_DO_SET_GLOBAL_ORIGIN'],
            ...
            'FAILURE_UNIT_SYSTEM_TRAFFIC_AVOIDANCE': cls.__constants['FAILURE_UNIT_SYSTEM_TRAFFIC_AVOIDANCE'],
            'FAILURE_UNIT_DATALINK_LTE': cls.__constants['FAILURE_UNIT_DATALINK_LTE'],
            'FAILURE_UNIT_DATALINK_WIFI': cls.__constants['FAILURE_UNIT_DATALINK_WIFI'],
            'FAILURE_UNIT_DATALINK_TELEM_RADIO': cls.__constants['FAILURE_UNIT_DATALINK_TELEM_RADIO'],
            'FAILURE_UNIT_BUS_CAN': cls.__constants['FAILURE_UNIT_BUS_CAN'],
            'FAILURE_UNIT_BUS_I2C': cls.__constants['FAILURE_UNIT_BUS_I2C'],
    ...
    @property
    def VEHICLE_CMD_DO_SET_MISSION_CURRENT(self):
        """Message constant 'VEHICLE_CMD_DO_SET_MISSION_CURRENT'."""
        return Metaclass_VehicleCommand.__constants['VEHICLE_CMD_DO_SET_MISSION_CURRENT']
    ...
    @property
    def VEHICLE_CMD_DO_SET_GLOBAL_ORIGIN(self):
        """Message constant 'VEHICLE_CMD_DO_SET_GLOBAL_ORIGIN'."""
        return Metaclass_VehicleCommand.__constants['VEHICLE_CMD_DO_SET_GLOBAL_ORIGIN']
    ...
    def FAILURE_UNIT_SYSTEM_ESC(self):
        ...
        return Metaclass_VehicleCommand.__constants['FAILURE_UNIT_SYSTEM_ESC']

    @property
    def FAILURE_UNIT_SYSTEM_TRAFFIC_AVOIDANCE(self):
        """Message constant 'FAILURE_UNIT_SYSTEM_TRAFFIC_AVOIDANCE'."""
        return Metaclass_VehicleCommand.__constants['FAILURE_UNIT_SYSTEM_TRAFFIC_AVOIDANCE']

    @property
    def FAILURE_UNIT_DATALINK_LTE(self):
        """Message constant 'FAILURE_UNIT_DATALINK_LTE'."""
        return Metaclass_VehicleCommand.__constants['FAILURE_UNIT_DATALINK_LTE']

    @property
    def FAILURE_UNIT_DATALINK_WIFI(self):
        """Message constant 'FAILURE_UNIT_DATALINK_WIFI'."""
        return Metaclass_VehicleCommand.__constants['FAILURE_UNIT_DATALINK_WIFI']

    @property
    def FAILURE_UNIT_DATALINK_TELEM_RADIO(self):
        """Message constant 'FAILURE_UNIT_DATALINK_TELEM_RADIO'."""
        return Metaclass_VehicleCommand.__constants['FAILURE_UNIT_DATALINK_TELEM_RADIO']

    @property
    def FAILURE_UNIT_BUS_CAN(self):
        """Message constant 'FAILURE_UNIT_BUS_CAN'."""
        return Metaclass_VehicleCommand.__constants['FAILURE_UNIT_BUS_CAN']

    @property
    def FAILURE_UNIT_BUS_I2C(self):
        """Message constant 'FAILURE_UNIT_BUS_I2C'."""
        return Metaclass_VehicleCommand.__constants['FAILURE_UNIT_BUS_I2C']
...
class VehicleCommand(metaclass=Metaclass_VehicleCommand):
    ...
    Constants:
      ...
      VEHICLE_CMD_DO_SET_MISSION_CURRENT
      VEHICLE_CMD_DO_LAST
      ...
      VEHICLE_CMD_DO_SET_GLOBAL_ORIGIN
      ...
      FAILURE_UNIT_SYSTEM_TRAFFIC_AVOIDANCE
      FAILURE_UNIT_DATALINK_LTE
      FAILURE_UNIT_DATALINK_WIFI
      FAILURE_UNIT_DATALINK_TELEM_RADIO
      FAILURE_UNIT_BUS_CAN
      FAILURE_UNIT_BUS_I2C
      FAILURE_TYPE_OK
      FAILURE_TYPE_OFF
      FAILURE_TYPE_STUCK
