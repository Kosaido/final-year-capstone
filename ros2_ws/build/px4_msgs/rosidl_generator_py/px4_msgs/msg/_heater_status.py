...
class HeaterStatus(metaclass=Metaclass_HeaterStatus):
    ...
    __slots__ = [
        ...
        '_temperature_activation_threshold_met',
        '_temperature_sensor',
        '_temperature_target',
    ...
    _fields_and_field_types = {
        ...
        'temperature_activation_threshold_met': 'boolean',
    ...
    def __init__(self, **kwargs):
        ...
        self.temperature_activation_threshold_met = kwargs.get('temperature_activation_threshold_met', bool())
    ...
    def __eq__(self, other):
        ...
        if self.temperature_target_met != other.temperature_target_met:
            return False
        if self.temperature_activation_threshold_met != other.temperature_activation_threshold_met:
            return False
    ...
    @builtins.property
    def temperature_activation_threshold_met(self):
        """Message field 'temperature_activation_threshold_met'."""
        return self._temperature_activation_threshold_met

    @temperature_activation_threshold_met.setter
    def temperature_activation_threshold_met(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'temperature_activation_threshold_met' field must be of type 'bool'"
        self._temperature_activation_threshold_met = value
