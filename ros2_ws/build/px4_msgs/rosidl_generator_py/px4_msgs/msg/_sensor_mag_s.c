...
bool px4_msgs__msg__sensor_mag__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._sensor_mag.SensorMag", full_classname_dest, 34) == 0);
  }
  px4_msgs__msg__SensorMag * ros_message = _ros_message;
  {  // timestamp
...
{
  /* NOTE(esteve): Call constructor of SensorMag */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._sensor_mag");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SensorMag");
