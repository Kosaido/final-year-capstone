...
bool px4_msgs__msg__heater_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // temperature_activation_threshold_met
    PyObject * field = PyObject_GetAttrString(_pymsg, "temperature_activation_threshold_met");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->temperature_activation_threshold_met = (Py_True == field);
    Py_DECREF(field);
  }
  {  // temperature_sensor
...
PyObject * px4_msgs__msg__heater_status__convert_to_py(void * raw_ros_message)
{
  ...
  {  // temperature_activation_threshold_met
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->temperature_activation_threshold_met ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "temperature_activation_threshold_met", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
