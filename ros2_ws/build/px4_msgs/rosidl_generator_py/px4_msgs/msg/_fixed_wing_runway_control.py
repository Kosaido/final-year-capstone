...
class FixedWingRunwayControl(metaclass=Metaclass_FixedWingRunwayControl):
    ...
    _fields_and_field_types = {
        ...
        'wheel_steering_yaw_setpoint': 'float',
    ...
    def __init__(self, **kwargs):
        ...
        self.wheel_steering_yaw_setpoint = kwargs.get('wheel_steering_yaw_setpoint', float())
    ...
    def __eq__(self, other):
        ...
        if self.wheel_steering_enabled != other.wheel_steering_enabled:
            return False
        if self.wheel_steering_yaw_setpoint != other.wheel_steering_yaw_setpoint:
            return False
    ...
    @builtins.property
    def wheel_steering_yaw_setpoint(self):
        """Message field 'wheel_steering_yaw_setpoint'."""
        return self._wheel_steering_yaw_setpoint

    @wheel_steering_yaw_setpoint.setter
    def wheel_steering_yaw_setpoint(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'wheel_steering_yaw_setpoint' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'wheel_steering_yaw_setpoint' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._wheel_steering_yaw_setpoint = value
