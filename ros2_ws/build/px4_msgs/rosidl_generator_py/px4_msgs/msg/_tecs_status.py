...
class TecsStatus(metaclass=Metaclass_TecsStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.weight_ratio = kwargs.get('weight_ratio', float())
    ...
    def __eq__(self, other):
        ...
        if self.fast_descend_ratio != other.fast_descend_ratio:
            return False
        if self.weight_ratio != other.weight_ratio:
            return False
        return True
    ...
    def weight_ratio(self):
        """Message field 'weight_ratio'."""
        return self._weight_ratio

    @weight_ratio.setter
    def weight_ratio(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'weight_ratio' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'weight_ratio' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._weight_ratio = value
