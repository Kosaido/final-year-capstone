...
bool px4_msgs__msg__sensor_accel_fifo__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._sensor_accel_fifo.SensorAccelFifo", full_classname_dest, 47) == 0);
  }
  px4_msgs__msg__SensorAccelFifo * ros_message = _ros_message;
  {  // timestamp
  ...
  {  // is_external
    PyObject * field = PyObject_GetAttrString(_pymsg, "is_external");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->is_external = (Py_True == field);
    Py_DECREF(field);
  }
  {  // dt
...
{
  /* NOTE(esteve): Call constructor of SensorAccelFifo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._sensor_accel_fifo");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SensorAccelFifo");
  ...
  {  // is_external
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->is_external ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "is_external", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // x
    ...
    memcpy(dst, src, 32 * sizeof(int16_t));
    Py_DECREF(field);
  }
  {  // y
    PyObject * field = NULL;
