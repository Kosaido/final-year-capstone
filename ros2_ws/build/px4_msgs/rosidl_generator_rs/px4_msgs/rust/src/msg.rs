...
impl BatteryStatus {
    ...
    pub const WARNING_UNHEALTHY: u8 = 6;

    /// Battery is charging
    pub const WARNING_CHARGING: u8 = 7;
...
pub struct CameraCapture {
    ...
    /// Report this capture to the ground station (CAMERA_IMAGE_CAPTURED); it is always logged regardless
    pub report: bool,
...
pub struct CellularStatus {
    ...
    pub link_tx_rate: u32,

    /// [KiB/s] [@invalid 0] Upload rate
    pub link_rx_rate: u32,
...
impl CellularStatus {
    ...
    pub const STATUS_FLAG_DISCONNECTING: u8 = 10;
    ...
    pub const STATUS_FLAG_CONNECTING: u8 = 11;

    /// One or more packet data bearers is active and connected
    pub const STATUS_FLAG_CONNECTED: u8 = 12;
  ...
  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        ...
        cell_tower_id: msg.cell_tower_id,
        band_number: msg.band_number,
        band_frequency: msg.band_frequency,
        channel_number: msg.channel_number,
        rx_level: msg.rx_level,
        tx_level: msg.tx_level,
        rx_quality: msg.rx_quality,
        sinr: msg.sinr,
      }),
      std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
      timestamp: msg.timestamp,
...
// Corresponds to px4_msgs__msg__DetectAndAvoid
...
impl DetectAndAvoid {
    ...
    // This constant is not documented.
    #[allow(missing_docs)]
    pub const DAA_CONFLICT_LVL_NONE: u8 = 0;


    // This constant is not documented.
    #[allow(missing_docs)]
    pub const DAA_CONFLICT_LVL_LOW: u8 = 1;


    // This constant is not documented.
    #[allow(missing_docs)]
    pub const DAA_CONFLICT_LVL_MEDIUM: u8 = 2;


    // This constant is not documented.
    #[allow(missing_docs)]
    pub const DAA_CONFLICT_LVL_HIGH: u8 = 3;


    // This constant is not documented.
    #[allow(missing_docs)]
    pub const DAA_CONFLICT_LVL_CRITICAL: u8 = 4;

    /// `unique_id` contains an ICAO address
    pub const UNIQUE_ID_ENCODING_ICAO: u8 = 0;

    /// `unique_id` contains an ADS-B callsign packed into a `uint64`
    pub const UNIQUE_ID_ENCODING_ADSB_CALLSIGN: u8 = 1;

    /// `unique_id` contains the reduced tail bytes of a UAS ID
    pub const UNIQUE_ID_ENCODING_UAS_ID: u8 = 2;
...
impl Default for DetectAndAvoid {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(super::msg::rmw::DetectAndAvoid::default())
  }
}

impl rosidl_runtime_rs::Message for DetectAndAvoid {
  type RmwMsg = super::msg::rmw::DetectAndAvoid;
  ...
  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        ...
        unique_id_encoding: msg.unique_id_encoding,
        conflict_level: msg.conflict_level,
        aircraft_dist: msg.aircraft_dist,
        aircraft_dist_hor: msg.aircraft_dist_hor,
        aircraft_dist_vert: msg.aircraft_dist_vert,
        expected_min_dist_time: msg.expected_min_dist_time,
      }),
      std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
      timestamp: msg.timestamp,
      unique_id: msg.unique_id,
...
// Corresponds to px4_msgs__msg__DetectAndAvoidMostUrgent
...
#[cfg_attr(feature = "serde", derive(Deserialize, Serialize))]
#[derive(Clone, Debug, PartialEq, PartialOrd)]
pub struct DetectAndAvoidMostUrgent {
    /// Time since system start
    pub timestamp: u64,
...
impl Default for DetectAndAvoidMostUrgent {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(super::msg::rmw::DetectAndAvoidMostUrgent::default())
  }
}

impl rosidl_runtime_rs::Message for DetectAndAvoidMostUrgent {
  type RmwMsg = super::msg::rmw::DetectAndAvoidMostUrgent;
...
impl DeviceInformation {
    ...
    /// Traffic Avoidance system (ADSB)
    pub const DEVICE_TYPE_TRAFFIC_AVOIDANCE: u8 = 16;

    /// Compute boards
    pub const DEVICE_TYPE_COMPUTE: u8 = 17;

    /// 3D scanning / multi-beam Lidar
    pub const DEVICE_TYPE_LIDAR: u8 = 18;

    /// stereo/depth camera
    pub const DEVICE_TYPE_STEREO_CAMERA: u8 = 19;
...
pub struct DifferentialPressure {
    ...
    /// [degC] [@invalid NaN if unknown] Pitot temperature (if available)
  ...
  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        ...
        temperature: msg.temperature,
        pitot_temperature: msg.pitot_temperature,
...
pub struct FailsafeFlags {
    ...
    /// Traffic avoidance (ADS-B/FLARM) system missing or unhealthy
    pub traffic_avoidance_unhealthy: bool,
  ...
  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        ...
        traffic_avoidance_unhealthy: msg.traffic_avoidance_unhealthy,
...
// Corresponds to px4_msgs__msg__FailureInjection
...
impl FailureInjection {
    ...
    // This constant is not documented.
    #[allow(missing_docs)]
    pub const FAILURE_UNIT_SYSTEM_ESC: u8 = 106;


    // This constant is not documented.
    #[allow(missing_docs)]
    pub const FAILURE_UNIT_SYSTEM_TRAFFIC_AVOIDANCE: u8 = 107;


    // This constant is not documented.
    #[allow(missing_docs)]
    pub const FAILURE_UNIT_DATALINK_LTE: u8 = 150;


    // This constant is not documented.
    #[allow(missing_docs)]
    pub const FAILURE_UNIT_DATALINK_WIFI: u8 = 151;


    // This constant is not documented.
    #[allow(missing_docs)]
    pub const FAILURE_UNIT_DATALINK_TELEM_RADIO: u8 = 152;


    // This constant is not documented.
    #[allow(missing_docs)]
    pub const FAILURE_UNIT_BUS_CAN: u8 = 200;


    // This constant is not documented.
    #[allow(missing_docs)]
    pub const FAILURE_UNIT_BUS_I2C: u8 = 201;
    ...
    // This constant is not documented.
    #[allow(missing_docs)]
    pub const FAILURE_TYPE_DRIFT: u8 = 8;
...
impl Default for FailureInjection {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(super::msg::rmw::FailureInjection::default())
  }
}

impl rosidl_runtime_rs::Message for FailureInjection {
  type RmwMsg = super::msg::rmw::FailureInjection;
  ...
  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        ...
        count: msg.count,
        unit: msg.unit,
        instance_mask: msg.instance_mask,
...
pub struct FixedWingRunwayControl {
    ...
    /// [@range -pi, pi] For the wheel controller to track. NAN means hold the heading captured when steering engaged.
    pub wheel_steering_yaw_setpoint: f32,
  ...
  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        ...
        wheel_steering_yaw_setpoint: msg.wheel_steering_yaw_setpoint,
...
// Corresponds to px4_msgs__msg__FixedWingTakeoffStatus
/// Status of a fixed-wing takeoff
/// Passes information from the FixedWingModeManager to the Navigator.

#[cfg_attr(feature = "serde", derive(Deserialize, Serialize))]
#[derive(Clone, Debug, PartialEq, PartialOrd)]
pub struct FixedWingTakeoffStatus {
    /// time since system start
    pub timestamp: u64,

    /// Whether the takeoff climbout is finished (altitude, or time if FW_TKO_CLMB_T is set)
    pub climbout_completed: bool,

}



impl Default for FixedWingTakeoffStatus {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(super::msg::rmw::FixedWingTakeoffStatus::default())
  }
}

impl rosidl_runtime_rs::Message for FixedWingTakeoffStatus {
  type RmwMsg = super::msg::rmw::FixedWingTakeoffStatus;

  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        timestamp: msg.timestamp,
        climbout_completed: msg.climbout_completed,
      }),
      std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
      timestamp: msg.timestamp,
      climbout_completed: msg.climbout_completed,
...
pub struct HeaterStatus {
    ...
    /// element driven this control period (controller_time_on_usec > 0)
    pub heater_on: bool,
    ...
    // This member is not documented.
    #[allow(missing_docs)]
    pub temperature_activation_threshold_met: bool,
    ...
    /// duty scaling from HEATERn_NOM_V: (V_nom/V)^2 above V_nom, 1 without compensation, 0 without battery data
  ...
  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        ...
        temperature_activation_threshold_met: msg.temperature_activation_threshold_met,
...
pub struct HomePosition {
    ...
    /// true when the orientation (roll, pitch, yaw) has been set
    pub valid_attitude: bool,
  ...
  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        ...
        valid_attitude: msg.valid_attitude,
...
impl InternalCombustionEngineStatus {
    ...
    pub const SUBSTATE_RUN: u8 = 0;

    /// The engine idle rpm controller is running.
    pub const SUBSTATE_IDLE: u8 = 1;

    /// The engine is at rest.
    pub const SUBSTATE_REST: u8 = 2;
  ...
  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        ...
        pid_idle_rpm_integral: msg.pid_idle_rpm_integral,
      }),
      std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
      timestamp: msg.timestamp,
      state: msg.state,
...
pub struct ManualControlSetpoint {
    ...
    /// manual control override request in an auto or offboard mode, only gets true if feature is enabled
...
// Corresponds to px4_msgs__msg__NfsUp
...
impl Default for NfsUp {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(super::msg::rmw::NfsUp::default())
  }
}

impl rosidl_runtime_rs::Message for NfsUp {
  type RmwMsg = super::msg::rmw::NfsUp;
...
// Corresponds to px4_msgs__msg__OpenDroneIdBasicId
...
impl Default for OpenDroneIdBasicId {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(super::msg::rmw::OpenDroneIdBasicId::default())
  }
}

impl rosidl_runtime_rs::Message for OpenDroneIdBasicId {
  type RmwMsg = super::msg::rmw::OpenDroneIdBasicId;
...
impl RegisterExtComponentRequest {
    ...
    pub const LATEST_PX4_ROS2_API_VERSION: u16 = 2;
...
// Corresponds to px4_msgs__msg__RtcmData
...
impl Default for RtcmData {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(super::msg::rmw::RtcmData::default())
  }
}

impl rosidl_runtime_rs::Message for RtcmData {
  type RmwMsg = super::msg::rmw::RtcmData;
...
pub struct SensorGps {
    ...
    /// Protocol of the last correction message the receiver parsed
    pub corrections_protocol: u8,

    /// Last correction message failed its CRC or content check
    pub corrections_crc_failed: bool,

    /// Whether the receiver used the last correction message
    pub corrections_msg_used: u8,
...
impl SensorGps {
    ...
    // This constant is not documented.
    #[allow(missing_docs)]
    pub const CORRECTIONS_PROTOCOL_UNKNOWN: u8 = 0;


    // This constant is not documented.
    #[allow(missing_docs)]
    pub const CORRECTIONS_PROTOCOL_RTCM3: u8 = 1;


    // This constant is not documented.
    #[allow(missing_docs)]
    pub const CORRECTIONS_PROTOCOL_SPARTN: u8 = 2;

    /// Galileo High Accuracy Service, received on E6
    pub const CORRECTIONS_PROTOCOL_HAS: u8 = 3;

    /// SPARTN over L-band (u-blox NEO-D9S)
    pub const CORRECTIONS_PROTOCOL_PMP: u8 = 4;

    /// QZSS CLAS
    pub const CORRECTIONS_PROTOCOL_QZSS_L6: u8 = 5;


    // This constant is not documented.
    #[allow(missing_docs)]
    pub const CORRECTIONS_MSG_USED_UNKNOWN: u8 = 0;


    // This constant is not documented.
    #[allow(missing_docs)]
    pub const CORRECTIONS_MSG_USED_NOT_USED: u8 = 1;


    // This constant is not documented.
    #[allow(missing_docs)]
    pub const CORRECTIONS_MSG_USED_USED: u8 = 2;
  ...
  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        ...
        corrections_protocol: msg.corrections_protocol,
        corrections_crc_failed: msg.corrections_crc_failed,
        corrections_msg_used: msg.corrections_msg_used,
...
pub struct SensorMag {
    ...
    /// magnetic field in the FRD board frame X-axis
    pub x: f32,

    /// magnetic field in the FRD board frame Y-axis
    pub y: f32,

    /// magnetic field in the FRD board frame Z-axis
    pub z: f32,
...
// Corresponds to px4_msgs__msg__SetpointConfig
...
impl SetpointConfig {
    ...
    pub const TYPE_DIRECT_ACTUATORS: u16 = 1;

    /// GotoSetpoint
    pub const TYPE_MULTICOPTER_GOTO: u16 = 2;

    /// FixedWingLateralSetpoint and FixedWingLongitudinalSetpoint
    pub const TYPE_FIXEDWING_LATERAL_LONGITUDINAL: u16 = 3;

    /// TrajectorySetpoint
    pub const TYPE_TRAJECTORY: u16 = 4;

    /// VehicleRatesSetpoint
    pub const TYPE_RATES: u16 = 5;

    /// VehicleAttitudeSetpoint
    pub const TYPE_ATTITUDE: u16 = 6;

    /// RoverPositionSetpoint
    pub const TYPE_ROVER_POSITION: u16 = 7;

    /// RoverSpeedSetpoint and RoverAttitudeSetpoint
    pub const TYPE_ROVER_SPEED_ATTITUDE: u16 = 8;

    /// RoverSpeedSetpoint and RoverRateSetpoint
    pub const TYPE_ROVER_SPEED_RATE: u16 = 9;

    /// RoverSpeedSetpoint and RoverSteeringSetpoint
    pub const TYPE_ROVER_SPEED_STEERING: u16 = 10;

    /// RoverThrottleSetpoint and RoverAttitudeSetpoint
    pub const TYPE_ROVER_THROTTLE_ATTITUDE: u16 = 11;

    /// RoverThrottleSetpoint and RoverRateSetpoint
    pub const TYPE_ROVER_THROTTLE_RATE: u16 = 12;

    /// RoverThrottleSetpoint and RoverSteeringSetpoint
    pub const TYPE_ROVER_THROTTLE_STEERING: u16 = 13;

    /// TrajectorySetpoint6dof
    pub const TYPE_TRAJECTORY_6DOF: u16 = 14;

    /// VehicleThrustSetpoint and VehicleTorqueSetpoint
    pub const TYPE_THRUST_AND_TORQUE: u16 = 15;

    /// PositionSetpointTriplet
    pub const TYPE_POSITION_TRIPLET: u16 = 16;
...
impl Default for SetpointConfig {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(super::msg::rmw::SetpointConfig::default())
  }
}

impl rosidl_runtime_rs::Message for SetpointConfig {
  type RmwMsg = super::msg::rmw::SetpointConfig;
...
// Corresponds to px4_msgs__msg__SetpointConfigReply
/// Reply to SetpointConfig

#[cfg_attr(feature = "serde", derive(Deserialize, Serialize))]
#[derive(Clone, Debug, PartialEq, PartialOrd)]
pub struct SetpointConfigReply {
    /// Time since system start
    pub timestamp: u64,
...
impl SetpointConfigReply {
    ...
    // This constant is not documented.
    #[allow(missing_docs)]
    pub const RESULT_FAILURE_OTHER: u8 = 1;

    /// Setpoint type is unsupported for the current vehicle
    pub const RESULT_UNSUPPORTED: u8 = 2;

    /// The setpoint type is not known
    pub const RESULT_UNKNOWN_SETPOINT_TYPE: u8 = 3;

}


impl Default for SetpointConfigReply {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(super::msg::rmw::SetpointConfigReply::default())
  }
}

impl rosidl_runtime_rs::Message for SetpointConfigReply {
  type RmwMsg = super::msg::rmw::SetpointConfigReply;
...
pub struct TecsStatus {
    ...
    /// Ratio of estimated vehicle weight to WEIGHT_BASE. Accounts for burned fuel if fuel-based weight compensation is enabled.
...
impl TransponderReport {
    ...
    // This constant is not documented.
    #[allow(missing_docs)]
    pub const PX4_ADSB_FLAGS_SIMULATED: u16 = 64;


    // This constant is not documented.
    #[allow(missing_docs)]
    pub const PX4_ADSB_FLAGS_VERTICAL_VELOCITY_VALID: u16 = 128;


    // This constant is not documented.
    #[allow(missing_docs)]
    pub const PX4_ADSB_FLAGS_BARO_VALID: u16 = 256;


    // This constant is not documented.
    #[allow(missing_docs)]
    pub const PX4_ADSB_FLAGS_SOURCE_UAT: u16 = 32768;
...
// Corresponds to px4_msgs__msg__UavcanFirmwareUpdate
...
#[cfg_attr(feature = "serde", derive(Deserialize, Serialize))]
#[derive(Clone, Debug, PartialEq, PartialOrd)]
pub struct UavcanFirmwareUpdate {
    /// time since system start (microseconds)
    pub timestamp: u64,
...
impl Default for UavcanFirmwareUpdate {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(super::msg::rmw::UavcanFirmwareUpdate::default())
  }
}

impl rosidl_runtime_rs::Message for UavcanFirmwareUpdate {
  type RmwMsg = super::msg::rmw::UavcanFirmwareUpdate;

  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        timestamp: msg.timestamp,
        pending_updates: msg.pending_updates,
      }),
      std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
      timestamp: msg.timestamp,
      pending_updates: msg.pending_updates,
...
impl VehicleCommand {
    ...
    /// Sets GNSS coordinates of the vehicle local origin (0,0,0) position. Send as COMMAND_INT with MAV_FRAME_GLOBAL_INT. |Unused|Unused|Unused|Unused|Latitude (WGS-84)|Longitude (WGS-84)| Altitude (AMSL)|
    pub const VEHICLE_CMD_DO_SET_GLOBAL_ORIGIN: u16 = 611;
...
pub struct VehicleLandDetected {
    ...
    /// true only if commanded to descend faster than 1.1 * LNDMC_Z_VEL_MAX for every update since the previous publication
    pub in_descend: bool,

    /// true only if throttle was at or below the low-throttle threshold for every update since the previous publication
    pub has_low_throttle: bool,

    /// false only if vertical velocity stayed below LNDMC_Z_VEL_MAX for every update since the previous publication
    pub vertical_movement: bool,

    /// false only if horizontal velocity stayed below LNDMC_XY_VEL_MAX for every update since the previous publication
    pub horizontal_movement: bool,

    /// false only if roll/pitch rate stayed below LNDMC_ROT_MAX for every update since the previous publication
    pub rotational_movement: bool,

    /// true only if close to the ground, or the check was skipped (no distance sensor), for every update since the previous publication
