  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: temperature_activation_threshold_met
  {
    cdr << (ros_message->temperature_activation_threshold_met ? true : false);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: temperature_activation_threshold_met
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->temperature_activation_threshold_met = tmp ? true : false;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name temperature_activation_threshold_met
  {
    size_t item_size = sizeof(ros_message->temperature_activation_threshold_met);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name temperature_sensor
  ...
  size_t current_alignment)
{
  ...
  // member: temperature_activation_threshold_met
  {
    size_t array_size = 1;
