...
class Init_SensorMag_is_external
{
public:
  explicit Init_SensorMag_is_external(::px4_msgs::msg::SensorMag & msg)
  : msg_(msg)
  {}
  Init_SensorMag_x is_external(::px4_msgs::msg::SensorMag::_is_external_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_SensorMag_is_external device_id(::px4_msgs::msg::SensorMag::_device_id_type arg)
  {
    msg_.device_id = std::move(arg);
    return Init_SensorMag_is_external(msg_);
  }
