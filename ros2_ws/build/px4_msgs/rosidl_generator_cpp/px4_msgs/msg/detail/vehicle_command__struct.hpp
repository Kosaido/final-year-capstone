...
struct VehicleCommand_
{
  ...
  static constexpr uint16_t VEHICLE_CMD_DO_GUIDED_LIMITS =
    222u;
  static constexpr uint16_t VEHICLE_CMD_DO_SET_MISSION_CURRENT =
    224u;
  ...
  static constexpr uint32_t VEHICLE_CMD_SET_NAV_STATE =
    100001u;
  static constexpr uint16_t VEHICLE_CMD_DO_SET_GLOBAL_ORIGIN =
    611u;
  ...
  static constexpr uint8_t FAILURE_UNIT_SYSTEM_ESC =
    106u;
  static constexpr uint8_t FAILURE_UNIT_SYSTEM_TRAFFIC_AVOIDANCE =
    107u;
  static constexpr uint8_t FAILURE_UNIT_DATALINK_LTE =
    150u;
  static constexpr uint8_t FAILURE_UNIT_DATALINK_WIFI =
    151u;
  static constexpr uint8_t FAILURE_UNIT_DATALINK_TELEM_RADIO =
    152u;
  static constexpr uint8_t FAILURE_UNIT_BUS_CAN =
    200u;
  static constexpr uint8_t FAILURE_UNIT_BUS_I2C =
    201u;
...
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t VehicleCommand_<ContainerAllocator>::VEHICLE_CMD_DO_SET_MISSION_CURRENT;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
...
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t VehicleCommand_<ContainerAllocator>::VEHICLE_CMD_DO_SET_GLOBAL_ORIGIN;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
...
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t VehicleCommand_<ContainerAllocator>::FAILURE_UNIT_SYSTEM_ESC;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t VehicleCommand_<ContainerAllocator>::FAILURE_UNIT_SYSTEM_TRAFFIC_AVOIDANCE;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t VehicleCommand_<ContainerAllocator>::FAILURE_UNIT_DATALINK_LTE;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t VehicleCommand_<ContainerAllocator>::FAILURE_UNIT_DATALINK_WIFI;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t VehicleCommand_<ContainerAllocator>::FAILURE_UNIT_DATALINK_TELEM_RADIO;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t VehicleCommand_<ContainerAllocator>::FAILURE_UNIT_BUS_CAN;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t VehicleCommand_<ContainerAllocator>::FAILURE_UNIT_BUS_I2C;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
