...
class Init_FixedWingRunwayControl_wheel_steering_yaw_setpoint
{
public:
  explicit Init_FixedWingRunwayControl_wheel_steering_yaw_setpoint(::px4_msgs::msg::FixedWingRunwayControl & msg)
  : msg_(msg)
  {}
  Init_FixedWingRunwayControl_wheel_steering_nudging_rate wheel_steering_yaw_setpoint(::px4_msgs::msg::FixedWingRunwayControl::_wheel_steering_yaw_setpoint_type arg)
  {
    msg_.wheel_steering_yaw_setpoint = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_FixedWingRunwayControl_wheel_steering_yaw_setpoint wheel_steering_enabled(::px4_msgs::msg::FixedWingRunwayControl::_wheel_steering_enabled_type arg)
  {
    msg_.wheel_steering_enabled = std::move(arg);
    return Init_FixedWingRunwayControl_wheel_steering_yaw_setpoint(msg_);
  }
