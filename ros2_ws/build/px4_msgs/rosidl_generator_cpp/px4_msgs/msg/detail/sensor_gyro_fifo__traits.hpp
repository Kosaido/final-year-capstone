  ...
  std::ostream & out)
{
  ...
  {
    out << "is_external: ";
    rosidl_generator_traits::value_to_yaml(msg.is_external, out);
    out << ", ";
  }
...
inline std::string to_yaml(const SensorGyroFifo & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const px4_msgs::msg::SensorGyroFifo & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const px4_msgs::msg::SensorGyroFifo & msg)
{
