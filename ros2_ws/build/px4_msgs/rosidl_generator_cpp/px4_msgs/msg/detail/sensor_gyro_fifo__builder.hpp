...
class Init_SensorGyroFifo_is_external
{
public:
  explicit Init_SensorGyroFifo_is_external(::px4_msgs::msg::SensorGyroFifo & msg)
  : msg_(msg)
  {}
  Init_SensorGyroFifo_dt is_external(::px4_msgs::msg::SensorGyroFifo::_is_external_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_SensorGyroFifo_is_external device_id(::px4_msgs::msg::SensorGyroFifo::_device_id_type arg)
  {
    msg_.device_id = std::move(arg);
    return Init_SensorGyroFifo_is_external(msg_);
  }
