...
class Init_SensorGps_corrections_msg_used
{
public:
  explicit Init_SensorGps_corrections_msg_used(::px4_msgs::msg::SensorGps & msg)
  : msg_(msg)
  {}
  Init_SensorGps_antenna_offset_x corrections_msg_used(::px4_msgs::msg::SensorGps::_corrections_msg_used_type arg)
  {
    msg_.corrections_msg_used = std::move(arg);
...
class Init_SensorGps_corrections_crc_failed
{
public:
  explicit Init_SensorGps_corrections_crc_failed(::px4_msgs::msg::SensorGps & msg)
  : msg_(msg)
  {}
  Init_SensorGps_corrections_msg_used corrections_crc_failed(::px4_msgs::msg::SensorGps::_corrections_crc_failed_type arg)
  {
    msg_.corrections_crc_failed = std::move(arg);
    return Init_SensorGps_corrections_msg_used(msg_);
  }
...
class Init_SensorGps_corrections_protocol
{
public:
  explicit Init_SensorGps_corrections_protocol(::px4_msgs::msg::SensorGps & msg)
  : msg_(msg)
  {}
  Init_SensorGps_corrections_crc_failed corrections_protocol(::px4_msgs::msg::SensorGps::_corrections_protocol_type arg)
  {
    msg_.corrections_protocol = std::move(arg);
    return Init_SensorGps_corrections_crc_failed(msg_);
  }
...
public:
  ...
  : msg_(msg)
  {}
  Init_SensorGps_corrections_protocol selected_rtcm_instance(::px4_msgs::msg::SensorGps::_selected_rtcm_instance_type arg)
  {
    msg_.selected_rtcm_instance = std::move(arg);
    return Init_SensorGps_corrections_protocol(msg_);
  }
