...
struct BatteryStatus_
{
  ...
  static constexpr uint8_t WARNING_FAILED =
    4u;
  static constexpr uint8_t WARNING_UNHEALTHY =
    6u;
  static constexpr uint8_t WARNING_CHARGING =
    7u;
...
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t BatteryStatus_<ContainerAllocator>::WARNING_UNHEALTHY;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t BatteryStatus_<ContainerAllocator>::WARNING_CHARGING;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
