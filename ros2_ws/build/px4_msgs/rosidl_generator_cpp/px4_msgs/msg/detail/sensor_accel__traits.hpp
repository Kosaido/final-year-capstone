...
inline std::string to_yaml(const SensorAccel & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const px4_msgs::msg::SensorAccel & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const px4_msgs::msg::SensorAccel & msg)
{
