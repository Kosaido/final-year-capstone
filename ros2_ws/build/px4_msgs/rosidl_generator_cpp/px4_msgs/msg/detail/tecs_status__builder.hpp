...
class Init_TecsStatus_weight_ratio
{
public:
  explicit Init_TecsStatus_weight_ratio(::px4_msgs::msg::TecsStatus & msg)
  : msg_(msg)
  {}
  ::px4_msgs::msg::TecsStatus weight_ratio(::px4_msgs::msg::TecsStatus::_weight_ratio_type arg)
  {
    msg_.weight_ratio = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_TecsStatus_weight_ratio fast_descend_ratio(::px4_msgs::msg::TecsStatus::_fast_descend_ratio_type arg)
  {
    msg_.fast_descend_ratio = std::move(arg);
    return Init_TecsStatus_weight_ratio(msg_);
  }
