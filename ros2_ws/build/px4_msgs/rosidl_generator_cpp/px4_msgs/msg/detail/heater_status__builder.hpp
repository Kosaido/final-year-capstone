...
public:
  ...
  : msg_(msg)
  {}
  Init_HeaterStatus_nominal_multiplier feed_forward_value(::px4_msgs::msg::HeaterStatus::_feed_forward_value_type arg)
  {
...
class Init_HeaterStatus_temperature_activation_threshold_met
{
public:
  explicit Init_HeaterStatus_temperature_activation_threshold_met(::px4_msgs::msg::HeaterStatus & msg)
  : msg_(msg)
  {}
  Init_HeaterStatus_temperature_sensor temperature_activation_threshold_met(::px4_msgs::msg::HeaterStatus::_temperature_activation_threshold_met_type arg)
  {
    msg_.temperature_activation_threshold_met = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_HeaterStatus_temperature_activation_threshold_met temperature_target_met(::px4_msgs::msg::HeaterStatus::_temperature_target_met_type arg)
  {
    msg_.temperature_target_met = std::move(arg);
    return Init_HeaterStatus_temperature_activation_threshold_met(msg_);
  }
