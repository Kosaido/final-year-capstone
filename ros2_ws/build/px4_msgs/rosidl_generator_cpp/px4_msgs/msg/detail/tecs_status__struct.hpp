...
struct TecsStatus_
{
  ...
  using _weight_ratio_type =
    float;
  _weight_ratio_type weight_ratio;
  ...
  Type & set__weight_ratio(
    const float & _arg)
  {
    this->weight_ratio = _arg;
    return *this;
  }
  ...
  bool operator==(const TecsStatus_ & other) const
  {
    ...
    if (this->weight_ratio != other.weight_ratio) {
      return false;
    }
    return true;
  }
