...
class Init_SensorBaro_is_external
{
public:
  explicit Init_SensorBaro_is_external(::px4_msgs::msg::SensorBaro & msg)
  : msg_(msg)
  {}
  Init_SensorBaro_pressure is_external(::px4_msgs::msg::SensorBaro::_is_external_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_SensorBaro_is_external device_id(::px4_msgs::msg::SensorBaro::_device_id_type arg)
  {
    msg_.device_id = std::move(arg);
    return Init_SensorBaro_is_external(msg_);
  }
