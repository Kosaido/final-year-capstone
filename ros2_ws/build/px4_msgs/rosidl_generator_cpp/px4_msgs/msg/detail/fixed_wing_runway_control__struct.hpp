...
struct FixedWingRunwayControl_
{
  ...
  explicit FixedWingRunwayControl_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->wheel_steering_yaw_setpoint = 0.0f;
  ...
  using _wheel_steering_yaw_setpoint_type =
    float;
  _wheel_steering_yaw_setpoint_type wheel_steering_yaw_setpoint;
  ...
  Type & set__wheel_steering_yaw_setpoint(
    const float & _arg)
  {
    this->wheel_steering_yaw_setpoint = _arg;
    return *this;
  }
  ...
  bool operator==(const FixedWingRunwayControl_ & other) const
  {
    ...
    if (this->wheel_steering_yaw_setpoint != other.wheel_steering_yaw_setpoint) {
      return false;
    }
