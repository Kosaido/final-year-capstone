...
class Init_SensorAccelFifo_is_external
{
public:
  explicit Init_SensorAccelFifo_is_external(::px4_msgs::msg::SensorAccelFifo & msg)
  : msg_(msg)
  {}
  Init_SensorAccelFifo_dt is_external(::px4_msgs::msg::SensorAccelFifo::_is_external_type arg)
  {
    msg_.is_external = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_SensorAccelFifo_is_external device_id(::px4_msgs::msg::SensorAccelFifo::_device_id_type arg)
  {
    msg_.device_id = std::move(arg);
    return Init_SensorAccelFifo_is_external(msg_);
  }
