...
struct HeaterStatus_
{
  ...
  explicit HeaterStatus_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->temperature_activation_threshold_met = false;
  ...
  using _temperature_activation_threshold_met_type =
    bool;
  _temperature_activation_threshold_met_type temperature_activation_threshold_met;
  ...
  Type & set__temperature_activation_threshold_met(
    const bool & _arg)
  {
    this->temperature_activation_threshold_met = _arg;
    return *this;
  }
  ...
  bool operator==(const HeaterStatus_ & other) const
  {
    ...
    if (this->temperature_activation_threshold_met != other.temperature_activation_threshold_met) {
      return false;
    }
