...
px4_msgs__msg__HeaterStatus__are_equal(const px4_msgs__msg__HeaterStatus * lhs, const px4_msgs__msg__HeaterStatus * rhs)
{
  ...
  // temperature_activation_threshold_met
  if (lhs->temperature_activation_threshold_met != rhs->temperature_activation_threshold_met) {
    return false;
  }
  // temperature_sensor
  ...
  px4_msgs__msg__HeaterStatus * output)
{
  ...
  // temperature_activation_threshold_met
  output->temperature_activation_threshold_met = input->temperature_activation_threshold_met;
  // temperature_sensor
